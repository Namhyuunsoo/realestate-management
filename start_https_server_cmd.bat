...
:: DuckDNS + SSL 자동 갱신 백그라운드 시작
echo [INFO] DuckDNS 자동 IP 업데이트 및 SSL 인증서 갱신 시작...
...
echo ========================================
echo    부동산 관리 시스템 서버 시작 (HTTPS)
echo ========================================
echo.
echo 서버 주소: https://localhost:5000
echo 외부 접속: https://skrealestate.duckdns.org:5000
echo DuckDNS: 백그라운드에서 자동 실행 중
echo SSL 인증서: 자동 갱신 활성화
echo.
